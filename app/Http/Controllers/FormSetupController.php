...
class FormSetupController extends Controller {
  ...
  public function process(Request $request) {
    ...
    $request->validate([
      ...
      'pickup_day' => 'required_when:want_payroll,==,Yes,&&,preferred_pickup_method,==,Pick up',
      ...
      'tax_impound_interval' => 'required_when:want_payroll,==,Yes,&&,employees_has_deductions,==,Yes',
      'prefer_day_to_be_charged_from_bank' => 'required_when:want_payroll,==,Yes,&&,employees_has_deductions,==,Yes',
      'has_divisions' => 'required_if:want_payroll,==,Yes',
      'divisions' => 'required_when:want_payroll,==,Yes,&&,has_divisions,==,Yes',
      'payments_separated_by_divisions' => 'required_when:want_payroll,==,Yes,&&,has_divisions,==,Yes',
